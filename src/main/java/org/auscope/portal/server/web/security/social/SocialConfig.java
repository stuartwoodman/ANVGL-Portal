...
public class SocialConfig implements SocialConfigurer {
    ...
    public void addConnectionFactories(ConnectionFactoryConfigurer cfConfig, Environment env) {
        ...
        */
        ...
        // Linkedin
        LinkedInConnectionFactory liFactory = new LinkedInConnectionFactory(
                env.getProperty("linkedin.consumer.key"),
                env.getProperty("linkedin.consumer.secret"));
        liFactory.setScope(env.getProperty("linkedin.scope"));
        cfConfig.addConnectionFactory(liFactory);
    ...
    /* TODO: Create a custom one of these?
    @Bean
    public UsersConnectionRepository usersConnection
    */
    ...
    public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
        ...
        if (autoSignUp) {
            ...
            // Automatically creates corresponding APP_USER if it does not
            // exist.
            ConnectionSignUp connectionSignUp = new VglConnectionSignUp(/*appUserDAO*/userRepository);
